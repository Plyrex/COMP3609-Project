...
public class RotateFX implements ImageFX {
	...
	private static final int XPOS = 100;		// horizontal position of the image
	private static final int YPOS = 100;		// vertical position of the image
	...
	public RotateFX (GamePanel p, String name) {
		panel = p;
		...
		angle = 0;				// set to 10 degrees
		angleChange = 0;			// change to angle each time in update()
